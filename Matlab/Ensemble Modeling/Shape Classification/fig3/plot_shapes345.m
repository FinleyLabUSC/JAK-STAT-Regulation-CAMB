...
%% --- plot pStat +/- 95% CI
% figure()
[ph,msg]=jbfill(predTime_hours,pStat_mean+pStat_yCI95(2,:),pStat_mean+pStat_yCI95(1,:),my_cols(j+6,:),my_cols(j+6,:),1,0.2);
hold on;
plot(predTime_hours,pStat_mean,'-','color',my_cols(j+6,:),'LineWidth',2)
hold on;
...
fig_name = strcat('figures/shape345','_ci.png');
saveas(gcf,fig_name)
