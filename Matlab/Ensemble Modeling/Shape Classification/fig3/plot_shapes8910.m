...
%% --- plot pStat +/- 95% CI
% figure()
[ph,msg]=jbfill(predTime_hours,pStat_mean+pStat_yCI95(2,:),pStat_mean+pStat_yCI95(1,:),my_cols(j+1,:),my_cols(j+1,:),1,0.2);
hold on;
plot(predTime_hours,pStat_mean,'-','color',my_cols(j+1,:),'LineWidth',2)
hold on;
...
fig_name = strcat('figures/shape8910','_ci.png');
saveas(gcf,fig_name)
