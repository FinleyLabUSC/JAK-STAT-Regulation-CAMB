...
% Take predictions through 1 hour only
dr50 = dr50(:,1:61);
dr100 = dr100(:,1:61);
dr200 = dr200(:,1:61);
dr500 = dr500(:,1:61);
...
legend('50 ng/mL','100 ng/mL','200 ng/mL','500 ng/mL','1,000 ng/mL','5,000 ng/mL','Location','northeastoutside')
legend('boxoff')
...
saveas(gcf, 'figures/dose_response_timecourse.png')