function [s, Si_out, p_Si_out, Sti_out, p_Sti_out] = efast_ttest(Si,rangeSi, Sti,rangeSti,time_points,efast_var,y_var,y_var_label,alpha) % use rangeSi or ramgeSti from efast_sd
%Si=Si(:,time_points);
%Sti=Sti(:,time_points);
