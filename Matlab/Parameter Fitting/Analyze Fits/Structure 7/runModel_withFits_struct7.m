...
% Assign the fitted parameter values
                    k3 = free_params(1);
                k5 = free_params(2);
                deg_ratio = free_params(3);
                k8A = free_params(4);
                mult8B = free_params(5);
                mult8AB = free_params(6);
                k9 = free_params(7);
                k11 = free_params(8);
                k_13 = free_params(9);
                k14A = free_params(10);
                mult14B = free_params(11);
                mult14AB = free_params(12);
                k15 = free_params(13);
                k16 = free_params(14);
                k17outA = free_params(15);
                mult17B = free_params(16);
                k19 = 1;
                k21 = 1;
                k22 = 1;
                k23 = 1;
