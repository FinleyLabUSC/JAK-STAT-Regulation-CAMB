...
% Just for now
ALL_params = ALL_params(1001:2000,:);
...
save('cache/transloc_predA2.mat','transloc_predA')
save('cache/transloc_predB2.mat','transloc_predB')
save('cache/pStatA_norm2.mat','pStatA_norm')
save('cache/pStatB_norm2.mat','pStatB_norm')
save('cache/Bcl_pred2.mat','Bcl')
save('cache/pJAK2_norm2.mat','pJAK2_norm')
