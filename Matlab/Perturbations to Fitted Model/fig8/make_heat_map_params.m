...
%                 params(55,1) = 0.01;
               ...
               % params(60,1) = 1.92540883488874E-05;
                ...
                params(param1_ref,1) = params(param1_ref,1).*multiplier_vec(j);
                params(param2_ref,1) = params(param2_ref,1).*multiplier_vec(k);
...
save('output/result_mat_params.mat','result_mat')
...
%     set(p, 'Edgecolor','black','LineWidth',2)
    ...
    xlabel('k12')
    ylabel('k2')
    saveas(fig1,'figures/param_heat_map','png');
